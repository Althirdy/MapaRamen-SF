<template>
    <div
        class="bg-white border border-disabled rounded-lg shadow p-4 flex-1 "
    >
        <!-- Header Slot -->
        ...
        <!-- Card Content -->
        <div class="my-2">
            <h2 class="text-primary_dark text-3xl font-bold">
        ...
        <div class="flex justify-between items-center">
            <p class="text-secondary_dark text-[1rem]">{{ label }}</p>
            <svg
                version="1.1"
                id="Layer_1"
