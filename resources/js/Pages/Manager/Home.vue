...
import CardList from "./HomeComponents/CardList.vue";

const CardStyle = " h-full p-4 border rounded-md shadow border-disabled";
</script>
<template>
    <Main>
        <!-- <header>
        ...
        <div
            class="max-w-screen-xl p-6 min-h-full flex flex-col mx-auto bg-white rounded-md border border-disabled"
        >
            <header class="space-y-[-.5rem]">
                <h1 class="text-primary_dark font-bold text-[2rem]">
                    Dashboard
                </h1>
                <p class="text-[1rem] text-secondary_dark">
                    Your sales, inventory, and team overview in one place.
                </p>
            </header>
            <CardList />
            <section class="grid lg:grid-cols-3 grid-cols-1 gap-4 mt-4 flex-1">
                <!-- Iventory Summary -->
                <div class="lg:col-span-2" :class="CardStyle">
                    <div class="flex flex-col gap-2">
                        <h2
                            class="text-secondary_dark font-semibold text-[1.2rem]"
                        >
                            Inventory Summary
                        </h2>
                        <SearchInput placeholder="Search ingredients..." class="max-w-[50%]" />
                    </div>
                </div>

                <!-- Active Crew -->
                <div :class="CardStyle" class="w-full">
                    <h2 class="text-secondary_dark font-semibold text-[1.2rem]">
                        Active Crew
                    </h2>
                    <!-- Container -->
                    <div class="mt-4">
